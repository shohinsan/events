...
<div class={cn('my-16 sm:mb-52 sm:mt-32')}>
	<section id="top" class="container grid items-center gap-6">
		<div class="flex max-w-[980px] flex-col items-start gap-2">
			...
			<p class="max-w-[700px] text-lg text-muted-foreground">
				...
				and its subsidiaries and affiliates (collectively, “we”, “us”, “our”) with respect to how we
				collect personal information. It also describes how we maintain, use, and disclose personal information.
			</p>
			...
			<p class="max-w-[700px] text-lg text-muted-foreground">
				We collect and store information that you voluntarily provide to us as well as data related
				to your website visit and usage.
			</p>
			<p class="max-w-[700px] text-lg text-muted-foreground">
				...
				provide personally identifiable information when you send us an email, use certain features
				of the website like the contact us form, or register with our site.
			</p>
			<p class="max-w-[700px] text-lg text-muted-foreground">
				In addition, during your visit we automatically collect certain aggregate information
				related to your website visit. Aggregate information is non-personally identifiable or
				anonymous information about you, including the date and time of your visit, your IP address,
				your computer browser information, the Internet address that you visited prior to and after
			...
			<p class="max-w-[700px] text-lg text-muted-foreground">
				...
				information to meet your requests for our products, programs, and services, to respond to
				your inquiries about our offerings, to offer you other products or services that we believe
				may be of interest to you, to enforce the legal terms that govern your use of our site,
			...
			<p class="max-w-[700px] text-lg text-muted-foreground">
				...
				We only disclose personally identifiable information about our users when we believe, in good
				faith, that either the law requires it, to protect the rights or property of {TERMS_PRIVACY_COMPANY},
			...
			<p class="max-w-[700px] text-lg text-muted-foreground">
				...
				information, and language selection. Cookies may be used whether you register with us or
				not.
			</p>
			<h4 class="mt-3 text-xl font-extrabold leading-tight tracking-tighter md:text-2xl">
				Security
			...
			<p class="max-w-[700px] text-lg text-muted-foreground">
				...
				However, please note that your identification, billing and contact information will remain
				on our records for some period.
			</p>
			<h4 class="mt-3 text-xl font-extrabold leading-tight tracking-tighter md:text-2xl">
